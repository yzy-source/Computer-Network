...
BOOL CClientDlg::OnInitDialog()
{
	...
	BOOL bFlag=client.Create(2001,SOCK_DGRAM,FD_READ|FD_WRITE);//以数据报方式创建socket
	if(!bFlag)
	{
...
void CClientDlg::OnBnClickedOk()
{
	// TODO: 在此添加控件通知处理程序代码
	UpdateData(true);
	client.SendTo(m_request.GetBuffer(),(m_request.GetLength()+1)*sizeof(TCHAR),m_port,m_ip);
